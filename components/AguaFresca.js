...
export default function AguaFresca() {
    const [Favorito, setFavorito] = useState([
        {
            id: 1, imagem: require('../assets/AguaNatural.jpg'), nome: 'Agua Fresca', tamanho: '300ml', preco: 'R$5,90', descricao: 'Água fresca é uma bebida popular no México, feita com frutas frescas, açúcar e água. As frutas são batidas e, em seguida, diluídas com água para obter um sabor suave e refrescante. Não leva conservantes ou corantes artificiais, sendo uma opção natural e saudável.', favorito: false },
  ]);
